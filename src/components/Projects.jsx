...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      tech: ["React", "Tailwind", "Framer Motion", "HTML", "CSS"],
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop",
      github: "https://github.com/Tanvir-yzu/Portfolio",
      live: "https://Tanvir-portfolio.vercel.app"
    },
    {
      title: "E-Commerce_tech",
      description: "E-Commerce_tech is a simple e-commerce platform with CRUD operations. Learning project to practice React hooks and state management with Django backend.",
      tech: ["Django", "JavaScript", "CSS", "Python"],
    ...
    },
    {
      ...
      tech: ["React", "API", "Tailwind", "HTML", "CSS"],
    ...
    },
    {
      ...
      tech: ["React", "Firebase", "Tailwind", "HTML", "CSS"],
    ...
    },
    {
      ...
      tech: ["React", "API", "CSS", "HTML", "JavaScript"],
    ...
    },
    {
      ...
      tech: ["React", "Chart.js", "LocalStorage", "HTML", "CSS", "JavaScript"],
    ...
    },
    {
      ...
      tech: ["React", "Firebase", "Tailwind", "HTML", "CSS", "JavaScript"],
    ...
    },
    {
      ...
      tech: ["React", "TMDB API", "Tailwind", "HTML", "CSS", "JavaScript"],
  ...
  return (
    <section ref={ref} className="w-full max-w-7xl mx-auto py-20">
      ...
      >
        <motion.div 
          className="inline-flex items-center gap-2 bg-secondary/20 px-4 py-2 rounded-full mb-6 mx-auto"
      ...
      >
        {projects.map((project, index) => (
          <SwiperSlide key={index}>
            <motion.div 
              className="group relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-secondary h-full transform-gpu"
              whileHover={{ 
                y: -15, 
                scale: 1.03,
                z: 30,
            ...
            >
              ...
              <div className="absolute inset-0 rounded-3xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-secondary/10 to-transparent opacity-0 group-hover:opacity-20 transition-all duration-500" 
              ...
              <div className="relative overflow-hidden h-56">
                ...
                {/* 3D Edge Highlight */}
                <div className="absolute inset-0 rounded-t-3xl pointer-events-none border border-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              ...
              <div className="p-6 relative">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((tech, i) => (
                    <motion.span 
                      key={i} 
                      className="bg-secondary/20 text-secondary text-xs px-3 py-1.5 rounded-full font-semibold backdrop-blur-sm"
                      whileHover={{ 
                        scale: 1.1, 
                ...
                <div className="flex gap-4">
                  <motion.a 
                    href={project.github} 
                    className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-full font-semibold shadow-lg transform-gpu"
                    whileHover={{ 
                      scale: 1.05, 
                      boxShadow: "0 10px 25px rgba(13, 36, 38, 0.4)",
                      z: 20,
                      rotateX: -5
                    }}
                    whileTap={{ scale: 0.95 }}
                  ...
                  >
                    <span style={{ transform: "translateZ(15px)" }}><FaGithub className="text-lg" /></span>
                    <span style={{ transform: "translateZ(15px)" }}>Code</span>
                  </motion.a>
                  <motion.a 
                    href={project.live} 
                    className="flex items-center gap-2 bg-secondary text-primary px-4 py-2 rounded-full font-semibold shadow-lg transform-gpu"
                    whileHover={{ 
                      scale: 1.05, 
                      boxShadow: "0 10px 25px rgba(174, 255, 114, 0.4)",
                      z: 20,
                      rotateX: -5
                    }}
                    whileTap={{ scale: 0.95 }}
                    style={{ transformStyle: "preserve-3d" }}
                  >
                    <span style={{ transform: "translateZ(15px)" }}><FaExternalLinkAlt /></span>
                    <span style={{ transform: "translateZ(15px)" }}>Demo</span>
                  </motion.a>
                </div>
              </div>
              
              {/* 3D Edge Highlight for Bottom */}
              <div className="absolute inset-0 rounded-3xl pointer-events-none border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      ...
      <style jsx>{`
        ...
        .projects-swiper :global(.swiper-button-prev:hover) {
          background: rgba(13, 36, 38, 0.8);
          transform: scale(1.1);
        }
        
        .projects-swiper :global(.swiper-pagination-bullet) {
          background: rgba(13, 36, 38, 0.3);
          opacity: 1;
          width: 10px;
          height: 10px;
        }
